...
function Header(props) {
  ...
  const LoginLogoutButton = () => (<Button variant="contained" onClick={loginLogoutButtonHandler}>{accessToken ? 'Logout' : 'Login'}</Button>)
  const BookShowButton = () => showBookShow ? (<Button className={classes.mr1} variant="contained" color="primary">Book Show</Button>) : ''
